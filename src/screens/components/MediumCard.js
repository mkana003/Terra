...
export default function MediumCard({item, type}) {
  ...
  return(
    <TouchableOpacity 
        style={{width:x(300), height:y(260), borderTopLeftRadius:x(30), borderTopRightRadius:x(30),marginRight:x(61),backgroundColor:Colors.background_color, ...styles.Shadow}}
        onPress={() => {move()}}    
    >
       <Image
            source={{uri:item.Image}}
            resizeMode="cover"
            style={{width:x(300),height:y(200),borderTopLeftRadius:x(30), borderTopRightRadius:x(30)}}
        />
